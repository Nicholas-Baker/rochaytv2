        ...
        <section>
          ...
          <listItemLockup>
            ...
            <relatedContent>
              <grid>
                <section>
                  <lockup vidUrl="https://s3-eu-west-1.amazonaws.com/rochaytv/NaveenTestimonial-A-HD.mov">
                    <img src="${this.BASEURL}resources/paulmckenna2.lcr" width="548" height="308" />
                    <title class="whiteText">Paul McKenna</title>
                  </lockup>
                  <lockup vidUrl="https://s3-eu-west-1.amazonaws.com/rochaytv/KevinTestimonial-C-HD.mov">
                    <img src="${this.BASEURL}resources/noel-edmonds.lcr" width="548" height="308" />
                    <title class="whiteText">Noel Edmonds</title>
                  </lockup>
                  <lockup vidUrl="https://s3-eu-west-1.amazonaws.com/rochaytv/NaveenTestimonial-B-HD.mov">
                    <img src="${this.BASEURL}resources/mark-aldridge.lcr" width="548" height="308" />
                    <title class="whiteText">Mark Aldridge</title>
                  </lockup>
                  <lockup vidUrl="https://s3-eu-west-1.amazonaws.com/rochaytv/KevinTestimonials-D-HD.mov">
            ...
            <relatedContent>
              <grid>
                <section>
                  ...
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_2.lcr" width="548" height="308" />
                    <title class="whiteText">Title 2</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_3.lcr" width="548" height="308" />
                    <title class="whiteText">Title 3</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_4.lcr" width="548" height="308" />
                    <title class="whiteText">Title 4</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_5.lcr" width="548" height="308" />
                    <title class="whiteText">Title 5</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_6.lcr" width="548" height="308" />
                    <title class="whiteText">Title 6</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_7.lcr" width="548" height="308" />
                    <title class="whiteText">Title 7</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_1.lcr" width="548" height="308" />
